...
import de.monochromata.jactr.rm.ScopedRetrievalModule6Test;
 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ ScopeTest.class, ScopedRetrievalParticipantTest.class, ScopedRetrievalModule6Test.class, })
